...
class ProductStockResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'damaged_quantity' => $shouldHide ? null : $this->damaged_quantity,
            'available_quantity' => $shouldHide ? null : ($this->available_quantity ?? ($this->quantity - $this->reserved_quantity - ($this->damaged_quantity ?? 0))),
